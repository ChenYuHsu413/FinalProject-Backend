...
_CENTRES: dict[str, tuple[float, float]] = {
    "rotor_speed_mean": (8.9, 2.0),
    "rotor_speed_std": (56.5, 4.0),
    "rotor_speed_rms": (57.2, 4.0),
    "torque_mean": (-0.02, 0.3),
    "torque_std": (6.69, 0.4),
    "torque_rms": (6.69, 0.4),
    "del_pos_mean": (19.4, 1.5),
    "del_pos_std": (9.30, 0.8),
    "del_pos_rms": (21.5, 1.5),
    "i_3p_a_rms": (4.69, 0.3),
    "i_3p_b_rms": (4.69, 0.3),
    "i_3p_c_rms": (4.69, 0.3),
    "direct_rms": (0.034, 0.004),
    "direct_std": (0.002, 0.0005),
    "quadrature_rms": (2.70, 0.2),
    "quadrature_std": (0.08, 0.01),
    "rod_demand_pos_mean": (120.0, 3.0),
    "rod_actual_pos_mean": (119.9, 3.0),
    "position_error_mean": (0.06, 0.01),
    "position_error_max": (0.31, 0.03),
